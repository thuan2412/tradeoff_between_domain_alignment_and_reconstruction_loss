...
def _hparams(algorithm, dataset, random_seed):
    ...
    if algorithm in ['DANN', 'CDANN']:
    ...
    elif algorithm == "IB_IRM": ### 4 parameteres nh dang de irm=100, ib=0
        _hparam('irm_lambda', 1e2, lambda r: 10**r.uniform(-1, 5))
        _hparam('irm_penalty_anneal_iters', 500,
                lambda r: int(10**r.uniform(0, 4)))
        ...
        _hparam('ib_penalty_anneal_iters', 500,
                lambda r: int(10**r.uniform(0, 4)))
        _hparam('recon_lambda', 1e2, lambda r: 10**r.uniform(-1, 5))
        _hparam('recon_penalty_anneal_iters', 500,
                lambda r: int(10**r.uniform(0, 4)))
    # elif algorithm == "IB_IRM":
    #     _hparam('mmd_lambda', 1e2, lambda r: 10**r.uniform(-2, 4))
    #     _hparam('mmd_penalty_anneal_iters', 500,
    #             lambda r: int(10**r.uniform(2, 4)))
    #     _hparam('ib_lambda', 1e2, lambda r: 10**r.uniform(-2, 4))
    #     _hparam('ib_penalty_anneal_iters', 500,
    #             lambda r: int(10**r.uniform(2, 4)))
