...
class Decoder(nn.Module):
    ...
    def __init__(self, input_shape= 28):
        ...
        self.deConv = nn.Sequential(
            ...
            nn.ReLU(),
            nn.ConvTranspose2d(64, 2, 3, 1, padding=1) ### 64,3,3,1
        )
    def decoder(self, z):
        x = z.view(-1,128,1,1)
        x = self.deConv(x)
...
# ##### decoder network for large datasets ( PACS VLCS office home  )    
# class Decoder(nn.Module):
...
#     def __init__(self, input_shape= 28):
#         super(Decoder, self).__init__()
#         self.decode = nn.Sequential(nn.Linear(200, 800), nn.ReLU(), nn.Dropout(0.25),
#                                     nn.Linear(800, 1024), nn.ReLU(), nn.Dropout(0.25),
